...
export declare function redpacketId(chain: Chain, input: RedPacket): string;
export declare function redpacketErc721Id(chain: Chain, input: RedPacketErc721): string;
