          ...
          <div class="record-box">
            <div style="display: block; position: relative;">
              <div class="icon" :style="r.action.type == 'receive' ? 'background-color: #4BAE4F;' : ''">
                ...
                <svg v-if="r.action.type == 'send'" style="color:white;" xmlns="http://www.w3.org/2000/svg" width="24"
                  height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"
                  stroke-linecap="round" stroke-linejoin="round" class="w-4 h-4 text-subdued">
              ...
              <div class="claim-status">
                <div style="display: flex; align-items: center;">
                  <div class="arrow">
                    ...
                    <svg v-if="r.action.type == 'send'" width="24" height="24" viewBox="0 0 24 24" fill="none"
                      xmlns="http://www.w3.org/2000/svg">
