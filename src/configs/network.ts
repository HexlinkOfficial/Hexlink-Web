...
export const getNetwork = (chain: string | number) : Network => {
    if (chain == "goerli" || chain == "5" || chain == 5) {
        return GOERLI;
    } else if (chain == "polygon" || chain == "137" || chain == 137) {
        return POLYGON;
    } else if (chain == "mumbai" || chain == "80001" || chain == 80001) {
        return MUMBAI;
    }
